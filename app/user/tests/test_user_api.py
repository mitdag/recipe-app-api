...
class PublicUserApiTests(TestCase):
    ...
    def test_password_too_short_error(self):
        """ Test an error is returns if the password is shorter than 5 chars """
...
class PrivateUserApiTests(TestCase):
    ...
    def setUp(self):
        ...
        # not create a token by calling token api. Instead we want rest_framework 
        # do this for us. Any request that we make to apis by using this user from here on will
        # be authenticated
    ...
    def test_post_me_not_allowed(self):
        """ Test post method is not allowed for me api.We use patch for updating. """
